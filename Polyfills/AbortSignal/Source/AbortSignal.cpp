...
namespace Babylon::Polyfills::Internal
{
    ...
    //{
    //    return Napi::Value::From(Env(), m_reason);
    //}

    //void AbortSignal::ThrowIfAborted(const Napi::CallbackInfo& )
    //{

    //}

    // TODO: Implement Static Methods
    //Napi::Value AbortSignal::Abort(const Napi::CallbackInfo& )
    //{
    //    return Napi::Value::From(Env(), 0);
    //}
    //
    //Napi::Value AbortSignal::Timeout(const Napi::CallbackInfo& )
    //{
    //    return Napi::Value::From(Env(), 0);
    //}
